...
public class Singleton {
    ...
    private void createAdvisorProfiles() {
        advisors.add(new Advisor("1", "Brittany Williams", AdvisorType.CAREER,"Proactive, organized and friendly Career Advisor that is ready for anything. I possess 5 years of experience in the field which include training in CVs,  cover letters and other career advisor areas.",
        ...
        advisors.add(new Advisor("2", "Thomas Edwards", AdvisorType.CAREER, "Talented Career Advisor with expertise in helping unemployed individuals and college graduates find gainful employment. Organised, proactive, and detail-orientated professional with strong communication and interpersonal abilities.\n", "- Resource advocacy\n" +
                "- Career planning\n" +
                "- Database management\n" +
                "- Networking\n" +
                "- Coaching\n" +
        ...
        advisors.add(new Advisor("3", "Daniel Wilson", AdvisorType.FINANCIAL, "Daniel is a competent Financial Advisor with experience in countless different situations. Daniel has over 8 years of successful business development.", "- Investment Strategies\n" +
        ...
        advisors.add(new Advisor("4", "Jaimie Miller", AdvisorType.FINANCIAL, "Jaimie focuses in portfolio diversity and secure investments. He excels at identifying and evaluating potential investment oppourtunities worldwide.", "- Business level Japanese and Mandarin\n" +
                "- Analytical skills\n" +
                "- Multi-Tasking\n" +
                "- Problem Solving\n" +
                ...
                "- Prospecting\n" +
                "- Compliance", image_5));
        advisors.add(new Advisor("5", "Raiqah Johal", AdvisorType.CAREER, "Raiqah works as a career coach in helping people understand their career goals. She has an ability to implement new initiatives regardless of the task or job you’re searching for.", "- Social media savvy\n" +
                "- Key relationship management\n" +
                "- Training opportunities\n" +
        ...
        advisors.add(new Advisor("6", "Bob Northchuck", AdvisorType.FINANCIAL, "Profesional Financial Advisor who is always ready to help with more than 20 years succsefully implementing wealth management, risk management and investment and financial strategies. ", "- Financial Management\n" +
                "- Management\n" +
                "- Microsoft Office\n" +
                "- Autocad\n" +
        ...
        advisors.add(new Advisor("7", "Alice Cooper", AdvisorType.CAREER, "Alice is a career advisor that can guarantee your entry into the career of your dreams. She is an expert at networking events and getting that first foot in the door.\n", "- Communication Skills\n" +
                "- Networking\n" +
